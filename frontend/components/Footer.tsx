        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <Link href={`/${locale}#masters`} className="hover:text-white transition">
                  {tNav('masters')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}#styles`} className="hover:text-white transition">
                  {tNav('styles')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}#info`} className="hover:text-white transition">
                  {tNav('info')}
                </Link>
              </li>
              <li>
